import { ElementRef, OnChanges, OnInit, ViewChild } from '@angular/core';
import { Component, EventEmitter, HostListener, Input, Output, SimpleChanges } from '@angular/core';
import { PepLoaderService, PepSessionService } from '@pepperi-addons/ngx-lib';
...
@Component({
    ...
    template: `<div id="settings-iframe-container">
                  <iframe *ngIf="iframeCookieVersionSrc?.length > 0" style="display:none"
                          width="0px" height="0px"  [src]="iframeCookieVersionSrc | safe"></iframe>
                  <iframe *ngIf="iframeSRC?.length > 0" #settingsIframe class="embed-responsive-item" id="myFrame"
